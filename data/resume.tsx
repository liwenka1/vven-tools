...
export const SiteMetadata: Metadata = {
	...
	description: "专业的在线工具集合平台，提供文本处理、开发工具、颜色工具、文件转换等50+实用工具。无需安装，数据本地处理，保护隐私安全",
	keywords: ["在线工具", "工具箱", "文本处理", "开发工具", "颜色工具", "文件转换", "效率工具", "免费工具", "前端工具", "实用工具"],
...
export const ProjectInfo = {
	...
	tagline: "专业在线工具箱",
	slogan: "效率工具，触手可及",
	description: "专业的在线工具集合平台，提供文本处理、开发工具、颜色工具、文件转换等50+实用工具。纯前端实现，数据本地处理，保护隐私安全，无需安装即可使用",
	version: "2.0.0",
	repository: {
		type: "github",
